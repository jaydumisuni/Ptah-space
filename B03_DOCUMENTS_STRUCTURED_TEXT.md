...
4. built-in safe HTML adapter that strips script/style/embedded active regions and emits passive text only;
...
11. A07 View specifications bound to the exact source Revision;
12. A07 converted-object registration specification using `RevisionRole::Converted` and exact source Revision provenance;
...
- canonical View specifications remain bound to the exact source Revision;
